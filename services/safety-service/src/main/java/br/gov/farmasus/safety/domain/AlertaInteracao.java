...
@Entity
@Table(
    name = "alertas_interacao",
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_alerta_event_prescricao", columnNames = {"event_id", "prescricao_id"})
    },
    indexes = {@Index(name = "idx_alerta_paciente", columnList = "paciente_id")})
public class AlertaInteracao {
  @Id
